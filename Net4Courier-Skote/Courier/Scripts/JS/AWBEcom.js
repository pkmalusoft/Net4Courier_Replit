...
function savemanualfixation() {
    ...
    $.ajax({
        type: 'POST',
        url: '/AWBEcom/UpdateDataFixation1',
      //  datatype: "html",
...
function savefixation() {
    ...
    for (i = 0; i < maxrow; i++) {
        ...
        if (maxrow == (i + 1)) {
            ...
            $.ajax({
                type: 'POST',
                url: '/AWBEcom/UpdateDataFixation',
                datatype: "html",
...
function savetrackstatus() {
    ...
    $.ajax({
        type: "POST",
        url: "/AWBEcom/SaveBatchTrackStatus",
        datatype: "Json",
        data: {
        ...
        success: function (response) {
            ...
            if (response.Status == "OK") {
                Swal.fire("Save Status!", response.message, "success");
                setTimeout(function () {
                    window.location.href = '/AWBEcom/Create?id=' + response.BatchID;
                }, 200)
            } else {
                Swal.fire("Save Status!", response.message, "error");
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.Status == "OK") {
                        ...
                        Swal.fire("Save Status!", response.message, "success");
                        setTimeout(function () {
                            window.location.href = '/AWBEcom/Index';
                        }, 200)
