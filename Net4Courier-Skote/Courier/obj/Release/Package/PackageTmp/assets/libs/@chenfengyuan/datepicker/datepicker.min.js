                ...
                this.built || this.build(),
                    ...
                    ((this.shown = !0),
                        ...
                        (this.$scrollParent.on(u, D.proxy(this.place, this)),
                            ...
                            D(document).on(n, (this.onGlobalClick = M(this.globalClick, this))),
                            D(document).on(o, (this.onGlobalKeyup = M(this.globalKeyup, this))),
                            i && D(document).on(f, (this.onTouchStart = M(this.touchstart, this))),
                            this.place()));
            },
            hide: function () {
                this.shown &&
                    (this.trigger(h).isDefaultPrevented() ||
                        ((this.shown = !1),
                            ...
                            this.inline || (this.$scrollParent.off(u, this.place), D(window).off(d, this.onResize), D(document).off(n, this.onGlobalClick), D(document).off(o, this.onGlobalKeyup), i && D(document).off(f, this.onTouchStart))));
            },
            toggle: function () {
            ...
            renderMonths: function () {
                ...
                for (t = 0; t <= 11; t += 1) {
                    var m = new Date(o, t, 1),
                        v = !1;
                    i && (v = (g = m.getFullYear() === i.getFullYear()) && m.getMonth() < i.getMonth()),
                        !v && a && (v = (y = m.getFullYear() === a.getFullYear()) && m.getMonth() > a.getMonth()),
            ...
            renderDays: function () {
                ...
                for ((i = M.getDay() - (parseInt(u, 10) % 7)) <= 0 && (i += 7), n && (F = M.getTime() <= n.getTime()), e = t - (i - 1); e <= t; e += 1) {
                    ...
                    n && (V = Y.getTime() < n.getTime()),
                        ...
                        C.push(this.createItem({ disabled: V, highlighted: $ === m && x === v && Y.getDate() === w, muted: !0, picked: $ === k && x === D && e === b, text: e, view: "day prev" }));
                }
                var T = [],
                    I = f,
                    S = g,
                ...
                for (r && (P = N.getTime() >= r.getTime()), e = 1; e <= i; e += 1) {
                    ...
                    r && (A = j.getTime() > r.getTime()),
                        ...
                        T.push(this.createItem({ disabled: A, picked: q, highlighted: I === m && S === v && j.getDate() === w, muted: !0, text: e, view: "day next" }));
                }
                var O = [];
                for (e = 1; e <= t; e += 1) {
                ...
                this.$monthPrev.toggleClass(l, F),
                    ...
                    this.$monthCurrent.toggleClass(l, F && P).html(s.yearFirst ? "".concat(f + p, " ").concat(d[g]) : "".concat(d[g], " ").concat(f).concat(p)),
        ...
        J = (function () {
            function i(t) {
                ...
                !(function (t, e) {
                    ...
                    (this.$element = D(t)),
                    (this.element = t),
                    (this.options = D.extend({}, s, y[e.language], D.isPlainObject(e) && e)),
                            ...
                            value: function () {
                                if (!this.built) {
                                    ...
                                    (this.$picker = i),
                                        ...
                                        this.inline ? D(e.container || t).append(i.addClass("".concat(c, "-inline"))) : (D(document.body).append(i.addClass("".concat(c, "-dropdown"))), i.addClass(g).css({ zIndex: parseInt(e.zIndex, 10) })),
                                        this.renderWeek();
                                }
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                D.isFunction(t.show) && e.on(p, t.show),
                                    ...
                                    this.inline || (t.trigger ? this.$trigger.on(n, D.proxy(this.toggle, this)) : this.isInput ? e.on(r, D.proxy(this.show, this)) : e.on(n, D.proxy(this.show, this)));
                            },
                        },
                        {
                            key: "unbind",
                            ...
                            value: function () {
                                if (!this.inline) {
                                    var t = this.$element,
                                        ...
                                        p = q;
                                    C(u) && (u = 10), o < d && s < d + r + o ? ((d -= o + u), (p = O)) : (d += r + u), a < c + h && ((c += n - h), (p = p.replace("left", "right"))), i.removeClass(z).addClass(p).css({ top: d, left: c });
                                }
                            },
                        },
                        {
