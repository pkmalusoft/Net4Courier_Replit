...
-- =============================================
CREATE TABLE IF NOT EXISTS "InscanMasters" (
    "Id" BIGSERIAL PRIMARY KEY,
    ...
    "ConsignorContact" VARCHAR(100),
    "ConsignorPhone" VARCHAR(50),
    "ConsignorMobile" VARCHAR(50),
    "ConsignorAddress1" VARCHAR(500),
    "ConsignorAddress2" VARCHAR(500),
    "ConsignorCity" VARCHAR(100),
    "ConsignorState" VARCHAR(100),
    "ConsignorCountry" VARCHAR(100),
    "ConsignorPostalCode" VARCHAR(20),
    "ConsignorLocation" VARCHAR(100),
    "OriginPortId" BIGINT,
    "OriginPortCode" VARCHAR(20),
    "Consignee" VARCHAR(200),
    "ConsigneeContact" VARCHAR(100),
    "ConsigneePhone" VARCHAR(50),
    "ConsigneeMobile" VARCHAR(50),
    "ConsigneeAddress1" VARCHAR(500),
    "ConsigneeAddress2" VARCHAR(500),
    "ConsigneeCity" VARCHAR(100),
    "ConsigneeState" VARCHAR(100),
    "ConsigneeCountry" VARCHAR(100),
    "ConsigneePostalCode" VARCHAR(20),
    "ConsigneeLocation" VARCHAR(100),
    "DestinationPortId" BIGINT,
    "DestinationPortCode" VARCHAR(20),
    "Pieces" INT,
    "Weight" DECIMAL(18,3),
    "StatedWeight" DECIMAL(18,3),
    "VerifiedWeight" DECIMAL(18,3),
    ...
    "HandlingInstructions" VARCHAR(500),
    "Remarks" VARCHAR(500),
    "CourierStatusId" INT NOT NULL DEFAULT 0,
    "StatusTypeId" INT,
    "SubReasonId" INT,
    "PaymentModeId" INT NOT NULL DEFAULT 0,
    "MovementTypeId" INT NOT NULL DEFAULT 1,
    "DocumentTypeId" INT NOT NULL DEFAULT 1,
    "ShipmentModeId" BIGINT,
    "ProductTypeId" INT,
    "ParcelTypeId" INT,
    "TypeOfGoodId" INT,
    ...
    "PODId" BIGINT,
    "ManifestId" BIGINT,
    "QuickInscanId" BIGINT,
    "QuickInscanMasterId" BIGINT,
    "BatchId" BIGINT,
    "ForwardingAgentId" BIGINT,
    "ForwardingAWBNo" VARCHAR(50),
    "ForwardingCharge" DECIMAL(18,2),
    "SpotRate" DECIMAL(18,2),
    "MarginPercent" DECIMAL(18,2),
    "ManifestWeight" DECIMAL(18,3),
    "IsNCND" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsCashOnly" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsChequeOnly" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsCollectMaterial" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsDOCopyBack" BOOLEAN NOT NULL DEFAULT FALSE,
    "AssignedEmployeeId" INT,
    "PickedUpEmployeeId" INT,
    "ReceivedByEmployeeId" INT,
    "PickedBy" VARCHAR(100),
    "ReceivedBy" VARCHAR(100),
    "PickupRequestDate" TIMESTAMP WITH TIME ZONE,
    "PickedUpDate" TIMESTAMP WITH TIME ZONE,
    "DeliveredDate" TIMESTAMP WITH TIME ZONE,
    "DeliveredTo" VARCHAR(200),
    "PODSignature" VARCHAR(500),
    "IsAutoGenerated" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsProcessed" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsReturnedToConsignor" BOOLEAN NOT NULL DEFAULT FALSE,
    "IsCOD" BOOLEAN NOT NULL DEFAULT FALSE,
    "CODAmount" DECIMAL(18,2),
    "CODCollected" BOOLEAN NOT NULL DEFAULT FALSE,
    "DutyVatAmount" DECIMAL(18,2),
    "DeviceId" VARCHAR(100),
    "EntrySource" INT,
    "JobCode" VARCHAR(50),
    "ReferenceNo" VARCHAR(100),
    "BarcodeImage" BYTEA,
    "BarcodeImageVertical" BYTEA,
    "IsRTS" BOOLEAN NOT NULL DEFAULT FALSE,
    "OriginalShipmentId" BIGINT,
    "RTSChargeMode" INT,
    "RTSCreatedAt" TIMESTAMP WITH TIME ZONE,
    "RTSCreatedByUserId" BIGINT,
    "RTSCreatedByUserName" VARCHAR(100),
    "RTSReason" VARCHAR(500),
    "PickupRequestId" BIGINT,
    "PickupRequestShipmentId" BIGINT,
    "MAWBId" BIGINT,
    "MAWBBagId" BIGINT,
    "MAWBNo" VARCHAR(50),
    "BagNo" VARCHAR(50),
    "BaggedAt" TIMESTAMP WITH TIME ZONE,
    "BaggedByUserId" BIGINT,
    "BaggedByUserName" VARCHAR(100),
    "IsOnHold" BOOLEAN NOT NULL DEFAULT FALSE,
    "HoldReason" VARCHAR(500),
    "HoldDate" TIMESTAMP WITH TIME ZONE,
    "HoldByUserId" BIGINT,
    "HoldByUserName" VARCHAR(100),
    "HoldReleasedDate" TIMESTAMP WITH TIME ZONE,
    "HoldReleasedByUserId" BIGINT,
    "HoldReleasedByUserName" VARCHAR(100),
