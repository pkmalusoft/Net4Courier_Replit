...
ALTER TABLE "ShipmentStatuses" ADD COLUMN IF NOT EXISTS "Description" VARCHAR(500);
ALTER TABLE "ShipmentStatuses" ADD COLUMN IF NOT EXISTS "GroupId" BIGINT;
...
ALTER TABLE "ShipmentStatuses" ADD COLUMN IF NOT EXISTS "SequenceNo" INT;
ALTER TABLE "ShipmentStatuses" ADD COLUMN IF NOT EXISTS "IsFinal" BOOLEAN DEFAULT FALSE;
