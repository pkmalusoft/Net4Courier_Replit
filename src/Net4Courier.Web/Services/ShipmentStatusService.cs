...
public class ShipmentStatusService
{
    ...
    public async Task SeedDefaultStatuses()
    {
        ...
        var statuses = new List<ShipmentStatus>
        {
            ...
            new() { StatusGroupId = groups[2].Id, Code = "ORIGIN_PROCESSED", Name = "Origin Processing Completed", TimelineDescription = "Sorted and routed", SequenceNo = 3, CreatedAt = DateTime.UtcNow },
