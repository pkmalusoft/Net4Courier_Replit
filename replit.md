...
- **Unified Warehouse Inscan**: The Pickup Inscan page (AWB mode) handles both domestic AWBs and import shipments. When an import AWB is scanned, it updates the status to ReceivedAtWarehouse instead of InscanAtOrigin. This provides a single scanning interface for warehouse staff receiving both domestic pickups and import shipments.
