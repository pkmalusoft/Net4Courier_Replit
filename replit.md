...
- **Import Shipment Charges**: Combined Duty/VAT Amount field and COD/Collection Amount field in import shipment dialog and data grid. Excel import/export supports these columns with automatic mapping (DutyVatAmount → DutyAmount, CodCollectionAmount → CODAmount) and IsCOD flag auto-set when COD amount is entered.
